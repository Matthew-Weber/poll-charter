	...
	Reuters.Graphics.overall = new Reuters.Graphics.stackPollCharter({
...
/*
		Reuters.Graphics.pollLines = new Reuters.Graphics.pollBarChart({
			el: "#reutersGraphic-chart1",
			dataURL: '//d3sl9l9bcxfb5q.cloudfront.net/json/cc_canada_immigration_poll_uscrossings',
// 			dataURL:"data/linedata.csv",
			height:120, //if < 10 - ratio , if over 10 - hard height.  undefined - square
			columnNames:{value:gettext("Value")}, // undefined uses sheet headers, object will map, array matches columnNamesDisplay
//			colors: [blue3, purple3,orange3, red3,yellow3],  //array or mapped object
//			dataType:'value',//value, changePreMonth, CumulativeChange, percentChange, cumulate
			YTickLabel: [[gettext(""),gettext("%")]], //  \u00A0  - use that code for a space.
//			xScaleTicks: 5,
